...
@section('pageInfo')
    <div class="page-header-title">
        <h5 class="m-b-10">Создание продукта</h5>
    </div>
    <ul class="breadcrumb">
...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="col">
                    <form role="form" action="{{route('admin.products.store')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="slug">Символьный код продукта</label>
