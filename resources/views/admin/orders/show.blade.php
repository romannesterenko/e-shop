...
@section('pageInfo')
    <div class="page-header-title">
        <h5 class="m-b-10">Просмотр категории "{{$order->name}}"</h5>
    </div>
    <ul class="breadcrumb">
                    ...
                    <form role="form" action="{{route('admin.categories.store')}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" value="{{$order->name}}" class="form-control" id="inputEmail4" placeholder="" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Символьный код категории</label>
                                <input type="text" class="form-control" value="{{$order->slug}}" name="slug"  id="inputPassword4" placeholder="" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Описание категории</label>
                            <textarea name="description" class="form-control" rows="5" disabled>{{$order->description}}</textarea>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{$order->meta_title}}" name="meta_title" class="form-control" id="inputEmail4" placeholder="" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Description</label>
                                <input type="text" value="{{$order->meta_descrip}}" class="form-control" name="meta_descrip"  id="inputPassword4" placeholder="" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Keywords</label>
                                <input type="text" class="form-control" value="{{$order->meta_keywords}}" name="meta_keywords"  id="inputPassword4" placeholder="" disabled>
                            </div>
                        </div>
                    </form>
                </div>
